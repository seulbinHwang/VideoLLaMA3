...
class ActivitynetQADataset(BaseEvalDataset):
    ...
    def load_data(self, data_root: str) -> Dict[int, Any]:
        ...
        for data in records:
            ...
            for video_format in video_formats:
                if os.path.exists(
                        os.path.join(video_folder, video_name + video_format)):
    ...
    def evaluate(self, results):
        ...
        def process_func(res):
            ...
            check_dict = prompt_gpt(self.client, data["question"],
                                    data["ground_truth"], res["prediction"],
                                    check_template)
        ...
        metrics, infos = {}, {}
        metrics["total"] = sum([res["match"] for res in total_results
                               ]) * 100 / len(total_results)
        metrics["total_score"] = sum([res["score"] for res in total_results
                                     ]) / len(total_results)
